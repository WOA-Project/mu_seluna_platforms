# @file
# Script to Build Selene UEFI firmware
#
...
class CommonPlatform():
    ...
    '''
    PackagesSupported = ("SelenePkg",)
    ArchSupported = ("AARCH64",)
    TargetsSupported = ("DEBUG", "RELEASE", "NOOPT")
    Scopes = ('Selene', 'gcc_aarch64_linux', 'edk2-build', 'cibuild', 'configdata')
...
class SettingsManager(UpdateSettingsManager, SetupSettingsManager, PrEvalSettingsManager, ParseSettingsManager):
    ...
    def GetPlatformDscAndConfig(self) -> tuple:
        ...
        '''
        return ("SelenePkg/SeleneNoSb.dsc", {})
...
class PlatformBuilder(UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv(self):
        ...
        self.env.SetValue("PRODUCT_NAME", "Selene", "Platform Hardcoded")
        self.env.SetValue("ACTIVE_PLATFORM", "SelenePkg/SeleneNoSb.dsc", "Platform Hardcoded")
