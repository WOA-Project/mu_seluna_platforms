# @file
# Script to Build Luna UEFI firmware
#
...
class CommonPlatform():
    ...
    '''
    PackagesSupported = ("LunaPkg",)
    ArchSupported = ("AARCH64",)
    TargetsSupported = ("DEBUG", "RELEASE", "NOOPT")
    Scopes = ('Luna', 'gcc_aarch64_linux', 'edk2-build', 'cibuild', 'configdata')
...
class PlatformBuilder(UefiBuilder, BuildSettingsManager):
    ...
    def SetPlatformEnv(self):
        ...
        self.env.SetValue("PRODUCT_NAME", "Luna", "Platform Hardcoded")
        self.env.SetValue("ACTIVE_PLATFORM", "LunaPkg/LunaNoSb.dsc", "Platform Hardcoded")
